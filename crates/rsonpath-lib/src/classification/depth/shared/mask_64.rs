...
pub(crate) struct DepthVector64<'a, B: InputBlock<'a>> {
    pub(crate) quote_classified: QuoteClassifiedBlock<B, u64>,
...
impl<'a, B: InputBlock<'a>> DepthBlock<'a> for DepthVector64<'a, B> {
    #[inline(always)]
